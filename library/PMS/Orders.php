...
class PMS_Orders
{
    ...
    public function add(array $params)
    {
        $f = new OSDN_Filter_Input(array(
            ...
            'print'                 => array('Int', 'allowEmpty' => true),
            'delivery'              => array('Int', 'allowEmpty' => true),
    ...
    public function update(array $params)
    {
        $f = new OSDN_Filter_Input(array(
            ...
            'print_end_fact'            => array(array('StringLength', 0, 10)),
            'delivery_start_planned'    => array(array('StringLength', 0, 10)),
            'delivery_start_fact'       => array(array('StringLength', 0, 10)),
            'delivery_end_planned'      => array(array('StringLength', 0, 10)),
            'delivery_end_fact'         => array(array('StringLength', 0, 10)),
            'success_date_planned'      => array(array('StringLength', 0, 10)),
            'success_date_fact'         => array(array('StringLength', 0, 10)),
