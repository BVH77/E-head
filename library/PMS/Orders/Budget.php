...
class PMS_Orders_Budget
{
    ...
    public function add(array $params)
    {
        $f = new OSDN_Filter_Input(array(
            ...
            'group_id'    => array('int', 'presence' => 'required'),
            'name'        => array(array('StringLength', 1, 255), 'presence' => 'required'),
            'measure'     => array(array('StringLength', 1, 255), 'presence' => 'required'),
            'qty'         => array(array('StringLength', 1, 255), 'presence' => 'required'),
            'price'       => array(array('StringLength', 1, 255), 'presence' => 'required'),
            'margin'      => array(array('StringLength', 1, 255), 'presence' => 'required')
        ), $params);
    ...
    public function getList(array $params, array $where = array())
    {
        ...
        $select->from(array('s' => $this->_table->getTableName()), '*')
            ->join(array('g' => 'orders_budget_groups'), 's.group_id=g.id',
                    array('group' => 'g.name'));
