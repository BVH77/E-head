...
CREATE TABLE IF NOT EXISTS `orders` (
  ...
  `print_start_planned` DATE NULL DEFAULT NULL,
  `print_start_fact` DATE NULL DEFAULT NULL,
  `print_end_planned` DATE NULL DEFAULT NULL,
  `print_end_fact` DATE NULL DEFAULT NULL,
