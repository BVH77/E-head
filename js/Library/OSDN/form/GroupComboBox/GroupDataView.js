 ...
 * @version 0.1.0
 */
Ext.namespace("OSDN.data");

OSDN.data.GroupDataView = Ext.extend(Ext.DataView, {
    initComponent : function(){
        OSDN.data.GroupDataView.superclass.initComponent.call(this);
		this.state = {};
        if(!this.startGroup){
    ...
    afterRender : function(){
        OSDN.data.GroupDataView.superclass.afterRender.call(this);
...
Ext.reg('OSDN.data.GroupDataView', OSDN.data.GroupDataView);