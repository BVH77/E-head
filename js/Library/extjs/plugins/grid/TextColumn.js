Ext.grid.TextColumn = function(config){
...
Ext.grid.TextColumn.prototype ={
    ...
    onMouseDown : function(e, t){
        if (!this.disabled && t.className && t.className.indexOf('x-grid3-cc-' + this.id) != -1) {
            ...
            if (false == this.grid.fireEvent('beforepress', xe)) return;
    ...
    renderer : function(v, p, record){
        ...
        var disabledClassName = (this.disabled || v == -1) ? 'x-item-disabled' : '';
