 ...
 * @version $Id: DateTimeField.js 5367 2008-11-14 12:09:07Z drongo $
 *
...
Ext.ux.form.DateTime = Ext.extend(Ext.form.Field, {
    ...
    initComponent:function() {
        ...
        var dateConfig = Ext.apply({}, {
            ...
            value: undefined == this.value ? null : ('object' == typeof this.value ? this.value : Date.parseDate(this.value, this.hiddenFormat)),
            listeners:{
				blur:{
                 	scope:this, 
                 	fn:this.onBlur
        ...
        var timeConfig = Ext.apply({}, {
            ...
            minValue: this.minTimeValue,
            maxValue: this.maxTimeValue,
            selectOnFocus:this.selectOnFocus,
    ...
    markInvalid: function () {
    	this.df.markInvalid.apply(this.df, arguments);
    	this.tf.markInvalid.apply(this.tf, arguments);
    },
     ...
     */
    isValid:function() {
        return this.df.isValid() && this.tf.isValid() && this.validateValue(this.getValue());
    }, // eo function isValid
    // }}}
    // {{{
    /**
