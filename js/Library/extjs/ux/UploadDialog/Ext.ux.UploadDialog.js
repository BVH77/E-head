...
p.i18n = {
    title: lang('File upload dialog', 'filemanager'),
    state_col_title: lang('State', 'filemanager'),
    state_col_width: 70,
    filename_col_title: lang('Filename', 'filemanager'),
    filename_col_width: 230,
    note_col_title: lang('Note', 'filemanager'),
    note_col_width: 150,
    add_btn_text: lang('Add'),
    add_btn_tip: lang('Add file into upload queue.', 'filemanager'),
    remove_btn_text: lang('Remove'),
    remove_btn_tip: lang('Remove file from upload queue.', 'filemanager'),
    reset_btn_text: lang('Reset'),
    reset_btn_tip: lang('Reset queue.', 'filemanager'),
    upload_btn_start_text: lang('Upload'),
    upload_btn_stop_text: lang('Abort'),
    upload_btn_start_tip: lang('Upload queued files to the server.', 'filemanager'),
    upload_btn_stop_tip: lang('Stop upload.', 'filemanager'),
    close_btn_text: lang('Close'),
    close_btn_tip: lang('Close the dialog.', 'filemanager'),
    progress_waiting_text: lang('Waiting...'),
    progress_uploading_text: lang('Uploading: {0} of {1} files complete.', 'filemanager'),
    error_msgbox_title: lang('Error'),
    permitted_extensions_join_str: ',',
    err_file_type_not_permitted: lang('Selected file extension isn\'t permitted.<br/>Please select files with following extensions: {1}', 'filemanager'),
    note_queued_to_upload: lang('Queued for upload.', 'filemanager'),
    note_processing: lang('Uploading...'),
    note_upload_failed: lang('Server is unavailable or internal server error occured.', 'filemanager'),
    note_upload_success: lang('OK'),
    note_upload_error: lang('Upload error.', 'filemanager'),
    note_aborted: lang('Aborted by user.', 'filemanager')
};
